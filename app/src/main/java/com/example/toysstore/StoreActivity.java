...
import com.example.toysstore.Widget.LaterReadWidget;
import com.example.toysstore.adapter.ToysAdapter;
import com.example.toysstore.database.LaterViewModel;
import com.example.toysstore.database.Toy;
import com.example.toysstore.database.ToysAsyncTask;
...
public class StoreActivity extends AppCompatActivity {
    ...
    @BindView(R.id.all)Button alltoys;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpViewModel();
        callTheAsyncTask();
        alltoys.setOnClickListener(new View.OnClickListener() {
            @Override
