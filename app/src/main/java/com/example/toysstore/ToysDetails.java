...
import com.example.toysstore.database.AppDatabase;
import com.example.toysstore.database.AppExecutors;
...
//                b.getDesc(), Toast.LENGTH_LONG).show();
        ...
        Picasso.get().load(imageUri).into(toyPic);
        ...
        buy_url.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String toyUrl= b.getBuy_url();
                Intent n = new Intent(Intent.ACTION_VIEW, Uri.parse(toyUrl));
                startActivity(n);
            }
        });
